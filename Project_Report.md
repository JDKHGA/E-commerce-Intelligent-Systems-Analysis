...
## 1. Executive Summary
This project analyzes customer behavior on an e-commerce platform to extract actionable insights for improving sales and engagement. Using a synthetic dataset simulating 2,000 customers and 1,000 transactions, a data processing pipeline was developed that includes data cleaning, feature engineering, and predictive modeling. Additionally, a real-time big data streaming architecture was simulated using Apache Kafka and Docker.

## 2. Methodology

### 2.1 Data Generation & Processing
*   **Synthetic Data:** A realistic dataset was generated using `numpy` and `pandas` to simulate customer demographics (Age, Gender, Location), product details (Category, Price), and transactional history (Timestamp, Quantity).
...
*   **Feature Engineering:** To enhance model performance, several features were engineered:
...
*   **Validation:** The data was split into 80% training and 20% testing sets. The model was evaluated using Accuracy Score and a Classification Report (Precision, Recall, F1-Score).

### 2.3 Big Data Architecture
To demonstrate readiness for high-velocity data environments, a streaming pipeline was implemented:
...
The analysis revealed several critical trends:
...
3.  **Demographic Targeting:**
    *   *Observation:* The age distribution of customers shows a specific concentration (e.g., 25-40 demographic).
...
Based on the data analysis and modeling results, the following actions are recommended:
